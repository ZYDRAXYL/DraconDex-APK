// The vault schema an APK install created before SDB 2.0 (vaultSchemaVersion
// 4), exactly as it was vendored at de081a1 — what VaultUpgrade has to bring
// forward. Renamed constants so a test can import it beside the current one.
...
const int vaultSchemaVersionV4 = 4;

const List<String> defaultColorCodesV4 = [
  '#6366f1',
  '#8b5cf6',
  '#ec4899',
  '#f43f5e',
...
const List<String> vaultCreateStatementsV4 = [
  // use_color
  '''
